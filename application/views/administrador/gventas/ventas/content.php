        ...
        <section class="content">
            ...
            <div id="contenido">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2" >
                    <select  class="form-control" id="regionseleccioada"  >
...
<option value="<?php echo $valor->id_medio;?>" ><?php echo $valor->nombre_medio?>   </option>  
  ...
  <div class="col-md-2"><form action="javascript:carcelarventa()" method="post" id="formcancel12341" >
                        <input id="txtidventacancelar" value="<?php echo $idventa;?>" class="hidden">
                        
                        <button type="submit" id="btncancelarventa"  class="fa btn btn-danger" form="formcancel12341" >Cancelar venta</button>
                    </form> </div>
  <div class="col-md-2"><form action="javascript:carcelarventa()" method="post" id="formrelizar12341" >
                        <input id="txtidventarealizar" value="<?php echo $idventa;?>" class="hidden">
                        
                        <button type="submit" id="btnralizarventa"  class="fa btn btn-success" form="formrelizar12341" >Confirmar venta</button>
                    </form>  </div>
</div>
...
?>    
  ...
  <div class="col-md-4"><input id="txttotal"  value="<?php echo $sub_total;?>" readonly="readonly" class="form-control"></div>
</div>
<?php else: ?>
